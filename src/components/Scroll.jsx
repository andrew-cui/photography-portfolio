...
const ScrollKey = ({ scrollPercentage = 50 }) => {
    const scrollDown = () => {
        ...
        <div className="scroll-wrapper">
            <button className="scroll-btn" onClick={scrollUp}>
                <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 16 L12 8 L20 16" fill="none" stroke="#27272a" stroke-width={1}/>
                </svg>
            </button>
            <button className="scroll-btn" onClick={scrollDown}>
                <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
                    <path d="M4 8 L12 16 L20 8" fill="none" stroke="#27272a" stroke-width={1}/>
                </svg> 
            </button>
        </div>
    );
